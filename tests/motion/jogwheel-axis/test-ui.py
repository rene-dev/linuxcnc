...
h.newpin("axis-x-jog-counts", hal.HAL_FLOAT, hal.HAL_OUT)
...
h.newpin("axis-y-jog-counts", hal.HAL_FLOAT, hal.HAL_OUT)
...
h.newpin("axis-z-jog-counts", hal.HAL_FLOAT, hal.HAL_OUT)
