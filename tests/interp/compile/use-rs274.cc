...
CANON_MOTION_MODE GET_EXTERNAL_MOTION_CONTROL_MODE() { return CANON_MOTION_MODE::EXACT_STOP; }
...
CANON_DIRECTION GET_EXTERNAL_SPINDLE(int spindle) { return CANON_DIRECTION::STOPPED; }
