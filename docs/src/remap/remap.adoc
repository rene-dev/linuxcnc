...
- When the message queued by a SELECT_TOOL() canon command is executed,
...
- When the message queued by the CHANGE_TOOL() canon command is executed,
...
.. enqueue an EMC_TOOL_LOAD message to `task`.
