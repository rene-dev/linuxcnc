...
| link:../man/man1/halui.1.html[halui]             |Observe HAL pins and command LinuxCNC                                          ||
...
| link:../man/man9/motion.9.html[motion] | Accepts motion commands, interacts with HAL in realtime             ||
